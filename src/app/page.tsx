...
export default function Home() {
  return (
    <main className="min-h-screen flex flex-col" style={{ backgroundColor: 'var(--black)', color: 'var(--cream)' }}>
      <Nav dark />
      ...
      <section className="flex flex-col items-center justify-center px-6 pt-32 pb-24 text-center">
        ...
        <div id="register" className="mt-12 w-full max-w-md">
          <RegistrationForm dark />
        </div>

      </section>

      {/* ── Divider ───────────────────────────────────────────── */}
      <div style={{ borderTop: '1px solid rgba(248,248,248,0.12)' }} />
      ...
      <section className="px-6 py-20 max-w-2xl mx-auto w-full">
        ...
        <h2 className="text-3xl font-bold mb-6" style={{ color: 'var(--cream)' }}>
          Why a ballot?
        </h2>
        <p className="text-base font-light leading-relaxed" style={{ color: 'rgba(248,248,248,0.65)' }}>
        ...
        <ol className="mt-10 space-y-5">
          {[
            ['Register', 'Enter your email below. You get a member number and a personal link.'],
            ...
            <li key={i} className="flex gap-5 items-start">
              ...
              <div>
                <p className="font-medium" style={{ color: 'var(--cream)' }}>{step}</p>
                <p className="text-sm mt-0.5" style={{ color: 'rgba(248,248,248,0.55)' }}>{desc}</p>
              </div>
            </li>
          ))}
        </ol>
      ...
      <section className="px-6 py-20 max-w-2xl mx-auto w-full">
        ...
        <div className="mt-10 flex flex-col sm:flex-row gap-6">
          {[
            ...
            <div key={value} className="flex-1" style={{ borderTop: '1px solid rgba(248,248,248,0.2)', paddingTop: '1rem' }}>
              <p className="text-2xl font-bold" style={{ color: 'var(--red)' }}>{value}</p>
              <p className="text-sm mt-1 font-light" style={{ color: 'rgba(248,248,248,0.55)' }}>{label}</p>
            </div>
          ))}
        </div>

        <div className="mt-10 flex flex-col sm:flex-row items-start gap-4 text-sm" style={{ color: 'rgba(248,248,248,0.5)' }}>
      ...
      <footer
        ...
        style={{ borderTop: '1px solid rgba(248,248,248,0.12)', color: 'rgba(248,248,248,0.35)' }}
      >
        <p>
