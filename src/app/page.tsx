  ...
  return (
    <div style={{ backgroundColor: '#FF3C00', overflowX: 'hidden' }}>
      ...
      <section ref={yellowRef} style={{
        ...
        <div style={{ position:'absolute', display:'flex', alignItems:'center', justifyContent:'center', left:'-128px', top:'479px', width:'492.711px', height:'601.124px', pointerEvents:'none', userSelect:'none', zIndex:0 }}>
        ...
        <div style={{ position:'absolute', display:'flex', alignItems:'center', justifyContent:'center', left:'-19.54px', top:'505.87px', width:'473.191px', height:'588.029px', pointerEvents:'none', userSelect:'none', zIndex:1 }}>
        ...
        <div style={{ position:'absolute', display:'flex', alignItems:'center', justifyContent:'center', left:'-48.51px', top:'503.64px', width:'582.055px', height:'653.043px', pointerEvents:'none', userSelect:'none', zIndex:2 }}>
          <div style={{ transform:'rotate(0deg)', flexShrink:0 }}>
        ...
        <div style={{ position:'absolute', display:'flex', alignItems:'center', justifyContent:'center', left:'5.23px', top:'885.12px', width:'123.221px', height:'153.639px', pointerEvents:'none', userSelect:'none', zIndex:3 }}>
