...
function HomeMobile() {
  ...
  async function handleShare() {
    ...
    const text = `pls sign up for this so that I can get us some sexy Moroccan rosé ${url}`
      ...
      <section ref={yellowRef} style={{
        ...
        {dismissed ? (
          ...
          <div style={{ opacity: stepIn ? 1 : 0, transition: 'opacity 0.4s ease', display: 'flex', flexDirection: 'column', flex: 1 }}>
            <div style={{ textAlign: 'center', maxWidth: '85%', margin: '0 auto 24px' }}>
              <p style={{ ...FONT, fontWeight: 700, fontSize: '16px', lineHeight: 1.27, color: '#FF3C00', textTransform: 'uppercase', marginBottom: '1.75em' }}>
                CAN&apos;T WAIT UNTIL THE 23RD OF JUNE?
              </p>
              <p style={{ ...FONT, fontWeight: 300, fontSize: '16px', lineHeight: 1.27, color: '#FF3C00' }}>
          ...
          <div style={{ opacity: stepIn ? 1 : 0, transition: 'opacity 0.22s ease', display: 'flex', flexDirection: 'column', flex: 1 }}>
            <p style={{ ...FONT, fontWeight: 300, fontSize: '18px', lineHeight: 1.27, letterSpacing: '0.16px', color: '#FF3C00', textAlign: 'center', width: 'calc(100% - 40px)', margin: '-32px auto 48px' }}>
              A curated package from a Berber-farmed vineyard in northern Morocco.<br /><br />At its centre, an amphora aged grenache ros&eacute;.<br />Just 480 bottles remain in existence.
            </p>
