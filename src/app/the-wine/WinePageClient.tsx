                ...
                <div style={ARCH}>
                  {i === 0 && (
                    <img
                      ...
                      alt={PRODUCTS[0].name}
                      style={{ width: '50%', height: 'auto', display: 'block', pointerEvents: 'none', marginBottom: '-3vw' }}
                    />
                  )}
                  {i === 1 && (
                    <img
                      ...
                      alt={PRODUCTS[1].name}
                      style={{ position: 'absolute', bottom: 0, left: '50%', transform: 'translateX(-50%)', height: '95%', width: 'auto', display: 'block', pointerEvents: 'none' }}
                    />
                  )}
                  {i === 2 && (
                    <img
