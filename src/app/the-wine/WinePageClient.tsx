              ...
              <div style={{
                ...
                {i === 3 ? (
                  ...
                  <img src={item.img} alt={item.name} style={{
                    ...
                    width: 'clamp(160px, 46.96vw, 812px)',
                    maxWidth: '170%',
                    height: 'auto',
                    display: 'block',
                    pointerEvents: 'none',
                  ...
                  <img src={item.img} alt={item.name} style={{ width: i === 0 ? '59%' : '53%', maxHeight: '90%', height: 'auto', display: 'block', marginBottom: i === 0 ? '-18px' : undefined }} />
                )}
              </div>
              <div style={{
